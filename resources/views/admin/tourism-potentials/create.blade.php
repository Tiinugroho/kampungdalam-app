...
<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3"><strong>Tambah Potensi Wisata</strong></h1>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.tourism-potentials.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="facilities" class="form-control" rows="3">{{ old('facilities') }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="access_route" class="form-control" rows="3">{{ old('access_route') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="estimated_duration" class="form-control" value="{{ old('estimated_duration') }}">
                        </div>
                    </div>
