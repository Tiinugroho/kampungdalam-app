...
@section('title', 'Tambah Data SGDs')
@section('content')
<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3"><strong>Tambah Data SGDs</strong></h1>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.sgds.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
